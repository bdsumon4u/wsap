...
// setup global const
const pupExecutablePath = process.env.PUPPETEER_EXECUTABLE_PATH || '/usr/bin/chromium-browser'
const sessionFolderPath = process.env.SESSIONS_PATH || './storage/framework/sessions/wsap'
...
const baseWebhookURL =
    ...
    "http://localhost:3000/localCallbackExample";
